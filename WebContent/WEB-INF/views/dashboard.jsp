...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="http://localhost:8080/PhoneMart/resources/img/sidebar-1.jpg">
      <!--
  ...
  <script src="http://localhost:8080/PhoneMart/resources/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
